...
public class SecondPage {
    ...
    public void priceFilter(String minPrice, String maxPrice){
        $x("//input[@data-meta-name='FilterRangeGroup__input-min']").setValue(minPrice);
        $x("//input[@data-meta-name='FilterRangeGroup__input-max']").clear();
        $x("//input[@data-meta-name='FilterRangeGroup__input-max']").setValue(maxPrice);
    }
